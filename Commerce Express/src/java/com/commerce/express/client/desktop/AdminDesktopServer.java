...
public class AdminDesktopServer extends JFrame
    ...
    private CommerceExpressCRUD commerceExpressFacade = CommerceExpressCRUD.getCommerceExpressCRUD();
    ...
    List<Product> p;
    int productArrSize;
    private String selectedProductToDelete;
    int position;
    Product productData1;

    private static final String categoryList[]={""};
    private static final String pickProductList[]={""};
    private static final String statusList[]={"Available","Sold out"};
    ...
    JComboBox deletePickProductComboBox = new JComboBox(pickProductList);
    ...
    JComboBox updatePickProductComboBox = new JComboBox(pickProductList);
    ...
    productCrudService = commerceExpressFacade.getProductCrudService();
    categoryCrudService = commerceExpressFacade.getCategoryCrudService();
   ...
   public void actionPerformed(ActionEvent e){
       ...
       Object source = e.getSource();
        ...
        if(source == addProductButton )
        {
                   ...
                   try
          {
              ...
              Product product = new ProductFactory.Builder(uniqueNum.toString())
                ...
                Category selectedCatergory1 = categoryCrudService.getByPropertyName("categoryName", catergoryComboBox.getSelectedItem().toString());
                productList = selectedCatergory1.getProducts();
                productList.add(product);
                selectedCatergory1.setProducts(productList);
                categoryCrudService.merge(selectedCategory);
        ...
        if(source == catergoryComboBoxForList)
        {
            ...
            Category selectedCategory1 = categoryCrudService.getByPropertyName("categoryName", selectedItem);
...
//          }
        ...
        if(source == updateCatComboBox)
        {
            ...
            selectedCategory = categoryCrudService.getByPropertyName("categoryName", selectedItem);
